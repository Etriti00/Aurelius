  ...
  return (
    <div className="relative liquid-glass-accent rounded-2xl sm:rounded-3xl p-6">
      ...
      <div className="relative">
            ...
            return (
              <motion.div
                ...
                className={`p-4 border rounded-lg hover:shadow-md transition-all duration-200 cursor-pointer group ${
                  threadUnread ? 'border-blue-200 bg-blue-50/50' : 'border-gray-200'
                }`}
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between">
                        <p className={`text-sm font-medium truncate ${
                          threadUnread ? 'text-gray-900' : 'text-gray-700'
                        }`}>
                          {senderName}
                        </p>
                      ...
                      <h4 className={`text-sm truncate ${
                        threadUnread ? 'font-semibold text-gray-900' : 'font-medium text-gray-700'
                      }`}>
                        {thread.subject}
                      </h4>
        ...
        <button className="w-full px-4 py-2 bg-black text-white text-sm font-semibold rounded-2xl shadow-lg shadow-black/25 hover:bg-gray-900 hover:shadow-xl hover:shadow-black/30 hover:scale-[1.02] transition-all duration-200 flex items-center justify-center space-x-2 group">
