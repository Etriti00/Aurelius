          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <Card className="liquid-glass-accent border-0">
              ...
              <CardContent>
                ...
                <p className="text-sm text-gray-600">With others</p>
              </CardContent>
            </Card>
          </div>
                    ...
                    {calendarDays.map((date, index) => {
                      ...
                      return (
                        <button
                          key={index}
                          className={`
                            min-h-[100px] p-2 border border-gray-100 relative cursor-pointer hover:bg-gray-50 transition-colors text-left w-full
                            ${today ? 'bg-blue-50 border-blue-200' : ''}
                            ${!currentMonth ? 'text-gray-400 bg-gray-50/50' : ''}
                          `}
                          onClick={() => {
                        ...
                        >
                          <div className="flex items-center justify-between mb-1">
                            <span className={`text-sm ${today ? 'font-bold text-blue-600' : ''}`}>
                              {date.getDate()}
                            </span>
                            {today && (
                          ...
                          <div className="space-y-1">
                            {dayEvents.slice(0, 3).map((event) => (
                              <button
                                ...
                                className={`
                                  text-xs p-1 rounded truncate cursor-pointer hover:scale-105 transition-transform w-full text-left
                  ...
                  {eventsLoading ? (
                    ...
                    <div className="space-y-4">
                      {filteredEvents.slice(0, 10).map((event) => (
                        <button 
                          key={event.id} 
                          className="flex items-start space-x-4 p-4 border rounded-lg hover:bg-gray-50 transition-colors cursor-pointer w-full text-left" 
