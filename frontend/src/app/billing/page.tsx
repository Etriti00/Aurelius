        ...
        <div className="space-y-8">
          ...
          <div className="liquid-glass-accent rounded-2xl sm:rounded-3xl p-6 sm:p-8">
            ...
            <div className="relative flex items-center justify-between">
              ...
              <div className="w-12 h-12 sm:w-16 sm:h-16 bg-black dark:bg-white rounded-2xl flex items-center justify-center shadow-lg shadow-black/25 dark:shadow-white/25 ml-4">
                <CreditCard className="w-6 h-6 sm:w-8 sm:h-8 text-white dark:text-black" />
              </div>
            </div>
          </div>
          ...
          <Tabs defaultValue="overview" className="space-y-6">
            ...
            <TabsContent value="overview" className="space-y-6">
                    ...
                    {subscription ? (
                      <>
                        ...
                        <div className="grid grid-cols-2 gap-4 text-sm">
                          <div>
                            <p className="text-gray-600 dark:text-gray-400">Current period starts</p>
                      ...
                      <div className="text-center py-8">
                        ...
                        <p className="text-gray-600 dark:text-gray-400 mb-4">Choose a plan to get started with Aurelius</p>
                        <Button 
                  ...
                  <CardContent className="space-y-4">
                    {usage ? (
                      <>
                        <div className="space-y-2">
                          <div className="flex justify-between text-sm">
                            <span className="text-gray-700 dark:text-gray-300">AI Actions</span>
                        ...
                        <div className="space-y-3 text-sm">
                          <div className="flex justify-between">
                            <span className="text-gray-600 dark:text-gray-400">Emails processed</span>
                            <span className="font-medium text-gray-900 dark:text-gray-100">{usage.totalEmailsProcessed}</span>
                          </div>
                          <div className="flex justify-between">
                            <span className="text-gray-600 dark:text-gray-400">Tasks automated</span>
                            <span className="font-medium text-gray-900 dark:text-gray-100">{usage.totalTasksAutomated}</span>
                          </div>
                          <div className="flex justify-between">
                      ...
                      <div className="text-center py-4">
                        <Zap className="w-8 h-8 text-gray-400 dark:text-gray-600 mx-auto mb-2" />
              ...
              <Card className="liquid-glass-accent border-0">
                <CardHeader>
                  <div className="flex items-center justify-between">
                    <div>
                      <CardTitle className="text-gray-900 dark:text-gray-100">Available Plans</CardTitle>
                      <CardDescription className="text-gray-600 dark:text-gray-400">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {Object.entries(PRICING_PLANS).map(([tier, plan]) => {
                      ...
                      return (
                        ...
                        `}>
                          {isCurrentPlan && (
                            <Badge className="absolute -top-2 left-4 bg-black dark:bg-white text-white dark:text-black">
                              Current Plan
                            </Badge>
                          )}
                          
                          <div className="text-center">
                            <h3 className="text-lg font-semibold mb-2 text-gray-900 dark:text-gray-100">{plan.name}</h3>
                            <div className="mb-4">
                              <span className="text-3xl font-bold text-gray-900 dark:text-gray-100">{formatCurrency(plan.price)}</span>
            ...
            <TabsContent value="usage" className="space-y-6">
              ...
              <Card className="liquid-glass-accent border-0">
                <CardHeader>
                  <CardTitle className="text-gray-900 dark:text-gray-100">Detailed Usage Analytics</CardTitle>
                  <CardDescription className="text-gray-600 dark:text-gray-400">
              ...
              <Card className="liquid-glass-accent border-0">
                ...
                <CardContent>
                  {invoicesLoading ? (
                    ...
                    <div className="space-y-4">
                      {invoices.data.map((invoice) => (
                        <div key={invoice.id} className="flex items-center justify-between p-4 border border-gray-200 dark:border-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                          <div>
                            <p className="font-medium text-gray-900 dark:text-gray-100">Invoice #{invoice.number}</p>
                            <p className="text-sm text-gray-600 dark:text-gray-400">
                    ...
                    <div className="text-center py-12">
                      <Download className="w-16 h-16 text-gray-400 dark:text-gray-600 mx-auto mb-4" />
                      ...
                      {paymentMethods.data.map((method) => (
                        <div key={method.id} className="flex items-center justify-between p-4 border border-gray-200 dark:border-gray-700 rounded-lg">
                          <div className="flex items-center space-x-3">
                            ...
                            <div>
                              <p className="font-medium text-gray-900 dark:text-gray-100">**** **** **** {method.card?.last4}</p>
                              <p className="text-sm text-gray-600 dark:text-gray-400">{method.card?.brand} • Expires {method.card?.expMonth}/{method.card?.expYear}</p>
                            </div>
                          </div>
