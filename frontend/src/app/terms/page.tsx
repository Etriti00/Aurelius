        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          >
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-12 mb-6">Acceptance of Terms</h2>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
                By accessing and using our services, you accept and agree to be bound by the terms 
                and provision of this agreement.
              </p>

              <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-12 mb-6">Use License</h2>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
                We grant you a limited, non-exclusive, non-transferable license to use our services 
                in accordance with these terms.
              </p>

              <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-12 mb-6">User Responsibilities</h2>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
                You are responsible for maintaining the confidentiality of your account and for all 
                activities that occur under your account.
              </p>

              <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-12 mb-6">Contact Information</h2>
